...
#define NAV_STARTUP_SPEED            1.0f    // 车辆启动速度（cm/s），克服静摩擦的最小速度，当规划速度低于此值时强制使用此值
...
#define NAV_TRAJ_SPEED_CAP           25.0f   // 梯形规划近目标速度上限（cm/s），提高以减少速度突降
#define NAV_NEAR_TARGET_GAIN         1.5f    // 近目标位置反馈增益系数，提高以增强小误差响应
#define NAV_NEAR_TARGET_SPEED_LIMIT  4.0f    // 近目标速度限幅倍数，提高允许更大调整速度
...
#define NAV_NEAR_TARGET_DEADBAND_RATIO  0.3f  // 近目标死区比例（相对于distance_threshold）
#define NAV_NEAR_TARGET_STOP_RATIO      0.5f  // 近目标停止阈值比例
