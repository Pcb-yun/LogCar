...
#define     LOG_BUFFER_SIZE    640              /**< log输出缓冲大小 */
...
#define     LOG_END            "\r\n"           /**< log信息结尾 */
#define     LOG_TIMESTAMP      0                /**< 是否添加时间戳 */
 ...
 */
#if LOG_TXT_STYLE == 1
        #if LOG_USING_COLOR == 1        // log级别字符(包含颜色)
        ...
        #endif
#elif LOG_TXT_STYLE == 2
#if LOG_TIMESTAMP == 1
        #define     ERROR_TEXT          "[ERROR](%d) %s:"
        #define     WARNING_TEXT        "[WARNING](%d) %s:"
        #define     INFO_TEXT           "[INFO](%d) %s:"
        #define     DEBUG_TEXT          "[DEBUG](%d) %s:"
        #define     VERBOSE_TEXT        "[VERBOSE](%d) %s:"
#else
        #define     ERROR_TEXT          "[ERROR]%s:"
        #define     WARNING_TEXT        "[WARNING]%s:"
        #define     INFO_TEXT           "[INFO]%s:"
        #define     DEBUG_TEXT          "[DEBUG]%s:"
        #define     VERBOSE_TEXT        "[VERBOSE]%s:"
#endif
#elif LOG_TXT_STYLE == 3
        #define     ERROR_TEXT          "[ERR ](%d) %s:"
        #define     WARNING_TEXT        "[WARN](%d) %s:"
        #define     INFO_TEXT           "[INFO](%d) %s:"
        #define     DEBUG_TEXT          "[DBUG](%d) %s:"
        #define     VERBOSE_TEXT        "[VERB](%d) %s:"
#endif
