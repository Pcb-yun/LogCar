...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = Tracking_SCL_Pin|Tracking_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(Tracking_SCL_GPIO_Port, Tracking_SCL_Pin);

    HAL_GPIO_DeInit(Tracking_SDA_GPIO_Port, Tracking_SDA_Pin);
